    ...
    session_start();
            ...
            // die("Connection failed: " . $conn->connect_error);
                ...
                if(isset($_POST['submit'])){
                    ...
                    $sql = "UPDATE `prescription` SET `GiveRights` = '$answers' WHERE `id` = '$id';";
                    $result = mysqli_query($conn, $sql);
                ...
                if(isset($_GET['performTask'])) {
                    ...
                    if(($_SESSION['Role']=='Pharmacist'&& $_SESSION["Situation"]=='Pharmacist Shop Visit') || ($_SESSION['Role']=='pharmacist'&& $_SESSION["Situation"]=='Pharmacist Shop Visit')  ){

                        $rr=3;
                        $ar=1;

                        if($_SESSION["Situation"]=='Pharmacist Shop Visit'){$sr = 3;}
                        ...
                        if (!$result4) {
                            echo "Error inserting in main table in result4 in prescription: " . mysqli_error($conn);
                        }
            ...
            try {
                ...
                while($row = $result->fetch_assoc()) {  // Displaying the catalogue
                    ...
                    foreach($ArrToStr as $x){
                            ...
                            ?>
                                ...
                                <div class="col-xxl-3 col-md-6 col-xs-12 container-fluid">
                                    <div class="card" style="max-width: 18rem;">
                                        <div class="card-body">
                                            <p class="card-text">
                                                <a href="?performTask=1&myTable=prescription&myId=<?php echo $row['id'] ?>" onclick="openMultipleLinks(<?php echo $row['id']; ?>, '<?php echo $row['Document']; ?>')">
                                                ...
                                                <script>
                                                    function openMultipleLinks(id, documentName){
                                                        ...
                                                        link = './uploadPrescription/'+documentName+'?performTask=1&myTable=prescription&myId='+id+'';
                        ...
                        <?php
                        } //End of if(role == admin) display all docs
                    }//End of foreach loop
                }//End of while loop
            }//End of try block
            catch(Exception $e) {
